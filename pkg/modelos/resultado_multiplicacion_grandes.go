...
const (
	...
	RUSA                         AlgoritmoMultiplicacionNumerosGrandes = "Multiplicación Rusa Estática"
	HINDU                        AlgoritmoMultiplicacionNumerosGrandes = "Multiplicación Hindú Estática"
	EGIPCIA                      AlgoritmoMultiplicacionNumerosGrandes = "Multipicación Egipcia Estática"
